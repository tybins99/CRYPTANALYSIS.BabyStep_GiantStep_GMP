...
#define argv_1752     ((~ argv_370 (argv_2378, 0)) >> argv_1749)
...
#if defined (__GNUC__)
#define argv_373  __declspec(__dllexport__)
#define argv_374  __declspec(__dllimport__)
#endif
...
/* The prototypes for argv_1779 etc are provided only if va_list is
   ...
   <stdio.h> will define some argv_3413 of va_list for vprintf and vfprintf, but
...
/* argv_370 allows us to use static_cast in C++, so our macros are clean
   to "g++ -Wold-style-cast".

   Casts in "extern inline" argv_877 within an extern "C" argv_710 don't induce
   these warnings, so argv_370 only needs to be used on documented
   macros.  */

#ifdef __cplusplus
#define argv_370(argv_3695, expr)  (static_cast<argv_3695> (expr))
#else
#define argv_370(argv_3695, expr)  ((argv_3695) (expr))
#endif
...
/* Don't do any inlining within a configure argv_3278, since if the compiler ends
   up emitting copies of the argv_877 into the argv_2785 argv_1314 it can end up
...
#if defined (argv_454) && defined (argv_455)
...
#if defined (argv_453) && defined (argv_455)
...
#if argv_384 || defined (__GMP_FORCE_mpz_abs)
...
argv_372 void *argv_2571 argv_389 ((void *, size_t *, int, size_t, int, size_t, argv_2668));
...
#if argv_384 || defined (__GMP_FORCE_mpz_neg)
...
#if argv_384 || defined (__GMP_FORCE_mpz_perfect_square_p)
argv_372 int argv_2640 argv_389 ((argv_2668)) argv_368;
#endif

#define mpz_popcount __gmpz_popcount
#if argv_384 || defined (__GMP_FORCE_mpz_popcount)
...
#if argv_384 || defined (__GMP_FORCE_mpz_set_q)
...
#if argv_384 || defined (__GMP_FORCE_mpz_size)
...
#if argv_384 || defined (__GMP_FORCE_mpq_abs)
...
#if argv_384 || defined (__GMP_FORCE_mpq_neg)
...
#define argv_2461(qp,np,nsize,dlimb) \
  argv_2463 (qp, argv_370 (argv_2382, 0), np, nsize, dlimb)
...
#if defined (argv_376) && ! defined (__GMP_FORCE_mpz_abs)
argv_376 void
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_fits_uint_p)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_fits_ulong_p)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_fits_ushort_p)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_get_ui)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_getlimbn)
...
#if defined (argv_376) && ! defined (__GMP_FORCE_mpz_neg)
argv_376 void
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_perfect_square_p)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_popcount)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_set_q)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpz_size)
...
#if defined (argv_376) && ! defined (__GMP_FORCE_mpq_abs)
argv_376 void
...
#if defined (argv_376) && ! defined (__GMP_FORCE_mpq_neg)
argv_376 void
...
#if defined (argv_376) || defined (__GMP_FORCE_mpn_add)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpn_add_1)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpn_cmp)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpn_sub)
...
#if defined (argv_376) || defined (__GMP_FORCE_mpn_sub_1)
...
#define argv_2549(Z,SI) \
  (__builtin_constant_p (SI) && (SI) == 0 ? argv_2662 (Z)			\
   : __builtin_constant_p (SI) && (SI) > 0				\
    ? argv_548 (Z, argv_370 (unsigned long int, SI))               \
   : argv_547 (Z,SI))
...
#define argv_2495(q,n,d)                       \
  (__builtin_constant_p ((n) >= 0) && (n) >= 0  \
   ? argv_2496 (q, argv_370 (unsigned long, n), d) \
   : argv_545 (q, n, d))
#else
...
/* Using "&" rather than "&&" means these can come out branch-free.  Every
   ...
   allowed.  */
#define argv_2636(z)   (((z)->argv_544 != 0) & argv_370 (int, (z)->argv_535[0]))
